...
export class GridMaterial extends BaseMaterial {
  ...
  private static _primaryScaleProperty =
    Shader.getPropertyByName("u_primaryScale");
  private static _secondaryScaleProperty =
    Shader.getPropertyByName("u_secondaryScale");
  private static _gridIntensityProperty =
    Shader.getPropertyByName("u_gridIntensity");
  private static _axisIntensityProperty =
    Shader.getPropertyByName("u_axisIntensity");
  private static _flipProgressProperty =
    Shader.getPropertyByName("u_flipProgress");
  ...
  set flipProgress(value: number) {
    this.shaderData.setFloat(
      GridMaterial._flipProgressProperty,
