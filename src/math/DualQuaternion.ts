import { MathUtil, Quaternion, Vector3 } from "oasis-engine";
...
export class DualQuaternion {
  ...
  static equals(a: DualQuaternion, b: DualQuaternion): boolean {
    ...
    return (
      Math.abs(a0 - b0) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a0), Math.abs(b0)) &&
      Math.abs(a1 - b1) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a1), Math.abs(b1)) &&
      Math.abs(a2 - b2) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a2), Math.abs(b2)) &&
      Math.abs(a3 - b3) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a3), Math.abs(b3)) &&
      Math.abs(a4 - b4) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a4), Math.abs(b4)) &&
      Math.abs(a5 - b5) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a5), Math.abs(b5)) &&
      Math.abs(a6 - b6) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a6), Math.abs(b6)) &&
      Math.abs(a7 - b7) <=
        MathUtil.zeroTolerance * Math.max(1.0, Math.abs(a7), Math.abs(b7))
    );
  }
